...
def resolve_icon(name: str) -> str:
    ...
    icon_map = {
        ...
        'chat-heart': Markup('xmlns="http://www.w3.org/2000/svg" width="40" height="32" fill="currentColor" '
                             'class="bi bi-chat-right-heart" viewBox="0 0 16 16"><path d="M2 1a1 1 0 0 0-1 1v8a1 '
                             '1 0 0 0 1 1h9.586a2 2 0 0 1 1.414.586l2 2V2a1 1 0 0 0-1-1zm12-1a2 2 0 0 1 2 2v12.793a.'
                             '5.5 0 0 1-.854.353l-2.853-2.853a1 1 0 0 0-.707-.293H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2z"/>'
